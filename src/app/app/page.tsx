			...
			<Tabs defaultValue="account" className="w-full max-w-[600px] flex">
				...
				<TabsContent value="account" className="mt-0">
					<Card className=" rounded-l-none">
						...
						<CardFooter>
							<Button variant={"gradient"} onClick={() => router.push("app/game/classic")}>Choose the classic game</Button>
						</CardFooter>
					</Card>
				</TabsContent>
				<TabsContent value="password" className="mt-0">
					<Card className="rounded-l-none">
						...
						<CardFooter>
							<Button variant={"gradient"} onClick={() => router.push('app/game/iamtheone')}>Choose the IAmTheOne game</Button>
						</CardFooter>
					</Card>
				</TabsContent>
				...
				<CardHeader>
						...
						<CardFooter>
							<Button variant={"gradient"} onClick={() => router.push('app/game/1v1')}>Choose the 1v1 game</Button>
						</CardFooter>
					</Card>
				</TabsContent>
