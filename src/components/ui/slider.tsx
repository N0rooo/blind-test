...
const Slider = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root> & {
    rangeClasseName ?: string
    trackClasseName ?: string
    thumbClassName ?: string
  }
>(({ rangeClasseName, thumbClassName, trackClasseName, className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className={cn("relative h-2 w-full grow overflow-hidden rounded-full bg-secondary", trackClasseName)}>
      <SliderPrimitive.Range className={cn("absolute h-full bg-primary", rangeClasseName)} />
