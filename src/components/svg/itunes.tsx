...
export default function ITunes({ height = 751, className, width = 2500, ...props }: Props) {
	return (
		<svg {...props} height={height} width={width} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 361 361" xmlSpace="preserve">
			<style type="text/css">
				{`
